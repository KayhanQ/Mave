...
@interface STTile : SPSprite {
    enum STType {STEMPTY = 0, STGROUND, STSPIKES, STROCK, STROCK2, STROUGH, STCRACK, STHOLE, STPLAYER, STPUSHROCK, STONEWAY, STPOPROCK, STSIGN, STSWITCH, STTRIGGER, STTELEPORTPAD, STFIREPORT, STBOX, STNPC, STTOMATO, STDICE, STWATER, STFINISH};
